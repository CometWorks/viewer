...
export function cacheElements() {
    for (const id of [
        "viewport", "loadingOverlay", "loadingTitle", "loadingText", "loadingProgress", "sceneSummary", "reloadScene", "assetStreamingStatus", "localAssetFallback", "fileAccessWarning", "fileAccessWarningDetail", "contentStatus", "pickContent", "folderPicker", "modsStatus", "pickMods", "modsFolderPicker", "showGridHelper", "showVoxels", "showContext", "showLighting", "showSun", "showClipping", "showLogistics", "showDamaged", "showFps",
